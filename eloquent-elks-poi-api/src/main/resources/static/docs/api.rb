...
module Model
  ...
  class PoiGetDto 
    ...
    # the json hash for this PoiGetDto
    def to_jaxb_json_hash
      _h = {}
      return _h
    end

    # the json (string form) for this PoiGetDto
    def to_json
      to_jaxb_json_hash.to_json
    end

    #initializes this PoiGetDto with a json hash
    def init_jaxb_json_hash(_o)
    end

    # constructs a PoiGetDto from a (parsed) JSON hash
    def self.from_json(o)
      if o.nil?
        return nil
      else
