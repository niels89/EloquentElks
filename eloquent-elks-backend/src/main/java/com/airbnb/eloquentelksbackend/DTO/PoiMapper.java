...
/**
 * Maps Points of Interest from Features (GeoJson) to @see {@link com.airbnb.eloquentelksbackend.entity.PoiGetDto}
 */
public class PoiMapper {

    /**
     * Maps GeoJson features to @see {@link com.airbnb.eloquentelksbackend.entity.PoiGetDto}
     *
     * @param features A list of GeoJson features
     * @return A list of @see {@link com.airbnb.eloquentelksbackend.entity.PoiGetDto}
     */
    ...
    /**
     * Takes a GeoJson feature and converts it to a @see {@link com.airbnb.eloquentelksbackend.entity.PoiGetDto}
     *
